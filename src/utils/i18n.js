...
const translations = {
    zh: {
        ...
        launcherCapability2D: '传统规则',
        launcherCapability3D: 'WebGL 3D',
        launcherCapabilityCoach: 'QI 指导',
        launcherCapabilityImport: '图片导入',
        gameGomokuTitle: '五子棋',
        gameGomokuTagline: '连五即胜，支持禁手、3D 场景、QI 指导与棋盘图片导入。',
        gameGoTitle: '围棋',
        gameGoTagline: '气、提子与数目终局，默认进入真实 3D 棋盘，支持 9/13/19 路。',
        gameChessTitle: '国际象棋',
        gameChessTagline: '王车易位、吃过路兵、升变规则完整，适合快速 AI 对战。',
        gameXiangqiTitle: '中国象棋',
        gameXiangqiTagline: '楚河汉界、九宫将帅，车马炮攻防节奏清晰。',
        gameJunqiTitle: '军棋',
        gameJunqiTagline: '二人陆战棋上下布阵、铁路行营与数字裁判；翻翻棋作为变体保留。',
        gameShogiTitle: '将棋',
        gameShogiTagline: '日本将棋——持驹打入、成区升变、二步禁止，棋局瞬息万变。',
        gameOthelloTitle: '黑白棋',
        gameOthelloTagline: '奥赛罗/黑白棋——翻转规则简洁，终局棋盘争夺扣人心弦。',
        shogiCheckmateBadge: '诘み',
        shogiCheckmateTitle: '{player} 胜',
        shogiCheckmateDetail: '对方玉将已被诘死（无合法走法且被将军），本局结束。',
        shogiStalemateBadge: '无走法',
        shogiStalemateTitle: '{player} 胜',
        shogiStalemateDetail: '对方无合法走法且未被将军，按规则判负。',
        shogiResignBadge: '认输',
        shogiResignTitle: '{player} 胜',
        shogiResignDetail: '认输结束本局，可以直接再开一局。',
        shogiSente: '先手',
        shogiGote: '後手',
        othelloBlack: '黑棋',
        othelloWhite: '白棋',
        ...
        goPass: '虚手',
        go3DToggle: '3D',
        go3DUnavailable: '3D 视图不可用，请开启 WebGL 或硬件加速。',
        renderer3DRequired: '当前棋局需要 WebGL 3D 渲染。请开启硬件加速或更换支持 WebGL 的浏览器。',
        ...
        coachPostGameTitle: '复盘分析',
        coachPostGameSummary: '棋局摘要',
        coachPostGameTurningPoints: '关键转折',
        coachPostGameMistakes: '双方失误',
        coachPostGameStrengths: '你的亮点',
        coachPostGameImprovements: '改进方向',
        coachPostGameRating: '表现评分',
        coachPostGameLoading: '正在生成复盘分析...',
        coachPostGameRequest: '请求复盘分析',
        coachPostGameUnavailable: '未配置LLM，无法进行复盘分析',
        ...
        noHintNeededGameOver: '对局已结束，这一局很精彩！',
    ...
    en: {
        ...
        medium: 'Medium',
        hard: 'Master',
        easyDesc: 'Random moves, great for beginners',
        mediumDesc: 'Minimax + Alpha-Beta pruning, basic tactics',
        hardDesc: 'Deep search with full board evaluation',
        aiLevelDesc: 'Select difficulty level',
        ...
        launcherCapability2D: 'Classic rules',
        launcherCapability3D: 'WebGL 3D',
        ...
        gameGoTitle: 'Go',
        gameGoTagline: 'Liberties, captures, and final scoring on a true 3D 9/13/19 board.',
        ...
        gameShogiTitle: 'Shogi',
        gameShogiTagline: 'Japanese chess — drops, promotion zone, and nifu prohibition for explosive tactical depth.',
        gameOthelloTitle: 'Othello',
        gameOthelloTagline: 'Reversi — a minute to learn, a lifetime to master: flip pieces and claim the board.',
        shogiCheckmateBadge: 'Checkmate',
        shogiCheckmateTitle: '{player} wins',
        shogiCheckmateDetail: 'Opposing king is checkmated — no legal moves and in check.',
        shogiStalemateBadge: 'No Moves',
        shogiStalemateTitle: '{player} wins',
        shogiStalemateDetail: 'Opponent has no legal move — ruled a loss per Shogi rules.',
        shogiResignBadge: 'Resigned',
        shogiResignTitle: '{player} wins',
        shogiResignDetail: 'The game was resigned. Start a new match anytime.',
        shogiSente: 'Sente',
        shogiGote: 'Gote',
        othelloBlack: 'Black',
        othelloWhite: 'White',
        ...
        goPass: 'Pass',
        go3DToggle: '3D',
        go3DUnavailable: '3D view unavailable. Enable WebGL or hardware acceleration.',
        renderer3DRequired: 'This game requires WebGL 3D rendering. Enable hardware acceleration or use a WebGL-capable browser.',
        ...
        coachPostGameTitle: 'Post-Game Analysis',
        coachPostGameSummary: 'Game Summary',
        coachPostGameTurningPoints: 'Key Turning Points',
        coachPostGameMistakes: 'Mistakes by Both Sides',
        coachPostGameStrengths: 'Your Strengths',
        coachPostGameImprovements: 'Areas for Improvement',
        coachPostGameRating: 'Performance Rating',
        coachPostGameLoading: 'Generating post-game analysis...',
        coachPostGameRequest: 'Request Post-Game Analysis',
        coachPostGameUnavailable: 'LLM not configured, cannot perform analysis',
        ...
        noHintNeededGameOver: 'The game has ended. Great match!',
