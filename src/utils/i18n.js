...
const translations = {
    zh: {
        ...
        scenePresence: '场景氛围',
        sceneHomeMood: '窗边对局',
        sceneHomeBlurb: '暖色灯光与木桌，适合安静推演。',
        sceneParkMood: '树荫棋桌',
        sceneParkBlurb: '冷绿天光，桌面更开阔明亮。',
        sceneCompetitionMood: '比赛大厅',
        sceneCompetitionBlurb: '冷白赛场灯光，突出棋盘本身。',
        sceneSoundHome: '室内暖光',
        sceneSoundPark: '微风水声',
        ...
        // 多游戏启动器
        launcherTitle: '两款棋类，一座 3D 对弈大厅',
        launcherSubtitle: '五子棋连珠与围棋围地，各自保留规则与 3D 棋盘。',
    ...
    en: {
        ...
        sceneHomeBlurb: 'Warm lamplight on a wooden table for quiet play.',
        sceneParkMood: 'Shade table',
        sceneParkBlurb: 'Cooler daylight and a more open tabletop.',
        sceneCompetitionMood: 'Match hall',
        sceneCompetitionBlurb: 'Cool arena lighting that keeps focus on the board.',
        ...
        // Multi-game launcher
        launcherTitle: 'Two board games, one 3D match hall',
        launcherSubtitle: 'Gomoku five-in-a-row and Go territory, each with its own rules and 3D board.',
