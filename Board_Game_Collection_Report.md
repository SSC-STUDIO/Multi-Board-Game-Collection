...
- **Testing**: Vitest ^4.1.5 — 1015 tests, 40 test files
- **Desktop**: Electron ^28.0.0 + electron-builder
- **Mobile**: Capacitor ^8.3.1 (Android APK)
- **i18n**: English / 简体中文

### Code Quality Metrics
- **Test Coverage**: 40 test files, 1015 tests, 100% pass rate
...
- [x] All 1015 tests pass, 111 modules verified, build clean
...
### Test & Build Status
- 1015 unit tests passing across 41 test files
...
### Highlights
- 999 unit tests passing across 41 test files (up from 1015)
